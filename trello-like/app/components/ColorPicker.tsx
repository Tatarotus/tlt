  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 border-b border-gray-200">
        ...
        <FilterTab 
          label="Primary" 
          active={activeGroup === 'primary'} 
          onClick={() => setActiveGroup('primary')} 
        />
        <FilterTab 
          label="Secondary" 
          active={activeGroup === 'secondary'} 
          onClick={() => setActiveGroup('secondary')} 
        />
        <FilterTab 
          label="Accent" 
          active={activeGroup === 'accent'} 
          onClick={() => setActiveGroup('accent')} 
        />
        <FilterTab 
          label="Neutral" 
  ...
  return (
    <button
      ...
      className={`
        ...
        ${isSelected ? 'ring-2 ring-gray-900 ring-offset-2 scale-105' : ''}
      `}
