...
return (
    ...
    <div
      className={`bg-white rounded-xl shadow-2xl flex overflow-hidden animate-in zoom-in-95 duration-200 transition-all ${isAiPanelOpen ? 'w-full max-w-5xl h-[90vh]' : 'w-full max-w-4xl max-h-[90vh]'}`}
